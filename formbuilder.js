...
function getSchema(formdef){
    ...
    $.each(formdef.formfields,function(index, value){
        ...
        if (!value.showname ||  !value.fieldname){
        ...
        if (value.fieldtype == "array" || value.fieldtype == "table"){
            ...
            $.each(value.listfields,function(listindex, listvalue){
                ...
                var listprop = baseProps(listindex, listvalue);
...
function showForm(value){
    ...
    //alert(JSON.stringify(value, null, "  "));
  	$("#schema").val(JSON.stringify(config, null, "  "));
...
{    
    "properties": {
         "fieldtype": {
            "enum":["text","checkbox", "select", "radio","textarea", "email","array", "table"]
        },
        "listfields" :{
        	"type":"array",
            "title":"List Fields",
             "items": baseFieldSchema
        }
    },
    "dependencies": {
        "fieldoptions": ["fieldtype"],
